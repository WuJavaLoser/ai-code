...
export async function getLoginUser(options?: { [key: string]: any }) {
  return request<API.ResultUserVo>('/user/get/login', {
    method: 'GET',
    ...(options || {}),
  })
}
...
export async function listUserVoByPage(body: API.UserQueryDto, options?: { [key: string]: any }) {
  return request<API.ResultPageResultUserVo>('/user/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function userLogin(body: API.UserLoginDto, options?: { [key: string]: any }) {
  return request<API.ResultUserVo>('/user/login', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
